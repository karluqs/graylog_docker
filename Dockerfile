# docker build --build-arg BUILD_DATE=`date -u +”%Y-%m-%dT%H:%M:%SZ”` --build-arg GRAYLOG_VERSION=3.0.2 --build-arg VCS_REF=000 -t karluqs/graylog .


# mkdir -p ${GRAYLOG_HOME}/data/journal && \
# mkdir -p ${GRAYLOG_HOME}/data/config && \
# chmod -R 0777 ${GRAYLOG_HOME}/data && \
